...
func NewOptions(options ...Option) Options {
	opts := Options{
		Cache:       rcache.New(registry.DefaultRegistry),
		...
		Broker:    rabbitmq.NewBroker(), // broker.Broker(),
...
func PublishContext(ctx broker.PublishOption) PublishOption {
	return func(o *PublishOptions) {
		o.Options = ctx
	}
}
