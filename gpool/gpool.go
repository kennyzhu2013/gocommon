...
const (
	...
	PoolTypeWorker     PoolType = 1
	PoolTypeWorkerFunc PoolType = 2
)
...
var (
	...
	// workerChanCap determines whether the channel of a worker should be a buffered channel to get the best performance. Inspired by fasthttp at
